...
const PILLARS = {
  ...
  productivity:{label:'Productivity',accent:'oklch(0.72 0.16 60)',sections:[{title:'Do',items:[{i:'check',n:'Tasks',b:'7',page:'tasks'},{i:'cal',n:'Calendar',b:null,page:'calendar'},{i:'clip',n:'Project Boards',b:'3',page:'projects'},{i:'timer',n:'Focus Sessions',b:null,page:'focus'}]},{title:'Track',items:[{i:'repeat',n:'Habits',b:null,page:'habits'},{i:'target',n:'Goals',b:'2',page:'goals'},{i:'note',n:'Journal',b:null,page:'journal'}]}]},
