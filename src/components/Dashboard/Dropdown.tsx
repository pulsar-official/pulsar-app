...
const PILLARS = {
  ...
  insights:{label:'Insights',accent:'oklch(0.72 0.14 200)',sections:[{title:'Metrics',items:[{i:'bar',n:'Productivity Score',b:null,page:'prodscore'},{i:'heat',n:'Focus Heatmap',b:null,page:'heatmap'},{i:'graph',n:'Knowledge Growth',b:null,page:'knowledgegrowth'}]},{title:'Reports',items:[{i:'sliders',n:'Custom Graph Builder',b:null,page:'graphbuilder'},{i:'timer',n:'Session Log',b:null,page:'sessionlog'},{i:'report',n:'Weekly Snapshot',b:'New',page:'weeklysnapshot'}]}]},
