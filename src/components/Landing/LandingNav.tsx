    ...
    <>
      <nav style={{
        ...
        <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', color: '#eeeef5' }}>
          ...
          <span style={{ fontWeight: 700, fontSize: '1.05rem', letterSpacing: '-0.02em', fontFamily: "'JetBrains Mono',monospace" }}>Pulsar</span>
        </a>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
            ...
            {isAuthed ? (
              <button
                ...
                style={{ padding: '8px 20px', borderRadius: 8, border: 'none', background: 'linear-gradient(135deg,#a78bfa,#7c3aed)', color: '#fff', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer', fontFamily: "'JetBrains Mono',monospace", transition: `all 0.22s ${E}`, display: 'flex', alignItems: 'center', gap: 6 }}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <button
                  ...
                  style={{ padding: '8px 18px', borderRadius: 8, border: '1px solid rgba(167,139,250,0.2)', background: 'transparent', color: '#a0a0b8', fontSize: '0.85rem', fontWeight: 500, cursor: 'pointer', fontFamily: "'JetBrains Mono',monospace", transition: `all 0.22s ${E}` }}
                ...
                <button
                  ...
                  style={{ padding: '8px 20px', borderRadius: 8, border: 'none', background: 'linear-gradient(135deg,#a78bfa,#7c3aed)', color: '#fff', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer', fontFamily: "'JetBrains Mono',monospace", transition: `all 0.22s ${E}` }}
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(167,139,250,0.3)' }}
                  onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = 'none' }}
          ...
          <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {isAuthed ? (
              <button onClick={() => { setMenuOpen(false); onGetStarted ? onGetStarted() : router.push('/') }}
                style={{ padding: '13px 20px', borderRadius: 8, border: 'none', background: 'linear-gradient(135deg,#a78bfa,#7c3aed)', color: '#fff', fontSize: '0.95rem', fontWeight: 600, cursor: 'pointer', fontFamily: "'JetBrains Mono',monospace" }}
              >Go to Dashboard →</button>
            ) : (
              <>
                <button onClick={() => { setMenuOpen(false); router.push('/sign-in') }}
                  style={{ padding: '13px 20px', borderRadius: 8, border: '1px solid rgba(167,139,250,0.2)', background: 'transparent', color: '#a0a0b8', fontSize: '0.95rem', fontWeight: 500, cursor: 'pointer', fontFamily: "'JetBrains Mono',monospace" }}
                >Sign In</button>
