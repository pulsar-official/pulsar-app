...
export default function Home() {
  return (
    <div>
      <h1 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '12px', color: 'oklch(0.95 0 0)', letterSpacing: '-0.3px', lineHeight: '1.2' }}>
        Dashboard
      </h1>
      <p style={{ fontSize: '12px', color: 'oklch(0.65 0 0)', marginBottom: '24px', margin: '0' }}>
      ...
      <div style={{
        ...
        {[
          ...
          >
            ...
            <h3 style={{ fontSize: '12px', fontWeight: 600, marginBottom: '3px', color: 'oklch(0.95 0 0)', margin: '0 0 3px 0' }}>
              {card.title}
            </h3>
            <div style={{ fontSize: '22px', fontWeight: 700, marginBottom: '2px', color: 'oklch(0.95 0 0)', letterSpacing: '-0.4px', margin: '0 0 2px 0' }}>
              {card.value}
            </div>
            <p style={{ fontSize: '10px', color: `oklch(0.65 0.14 ${card.color})`, margin: 0 }}>
              {card.trend}
            </p>
          </div>
        ))}
